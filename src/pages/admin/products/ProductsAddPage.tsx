        ...
        >
          <div className="grid grid-cols-2 gap-x-6">
            <div>
              ...
              <Form.Item<FieldType>
                ...
                name="name"
              >
                <Input className="h-11!" placeholder="Nomi" />
              </Form.Item>
            </div>
            ...
            <div>
              ...
              <Form.Item<FieldType>
                ...
                name="brand"
              >
                <Input className="h-11!" placeholder="Brand" />
              </Form.Item>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-x-6">
            <div>
              ...
              <Form.Item<FieldType>
                ...
                name="price"
              >
                <Input className="h-11!" placeholder="Narxi" />
              </Form.Item>
            </div>
            ...
            <div>
              ...
              <Form.Item<FieldType>
                ...
                name="quantity"
              >
                <Input type="number" className="h-11!" placeholder="Miqdori" />
              </Form.Item>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-x-6">
            <div>
              ...
              >
                <Input className="h-11!" placeholder="Pochkadagi soni" />
              </Form.Item>
            </div>
            ...
            <div>
              ...
              <Form.Item<FieldType>
                ...
                name="size"
              >
                <Input className="h-11!" placeholder="Razmeri" />
              </Form.Item>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-x-6">
            <div>
              ...
              <Form.Item<FieldType>
                ...
                name="shop_id"
              >
                <Select className="h-11!" placeholder="Do'kon" />
              </Form.Item>
            </div>
            ...
            <div>
              ...
              <Form.Item<FieldType>
                ...
                name="tsex_id"
              >
                <Select className="h-11!" placeholder="Tsex" />
              </Form.Item>
            </div>
          </div>
          ...
          <Form.Item>
            <div className="flex justify-end gap-4 pt-4">
              <Button className="h-10! bg-red-500! text-white!">
                Bekor qilish
              </Button>{" "}
