  ...
  return (
    <div className="grid grid-cols-4 gap-6 max-[1350px]:grid-cols-3 max-[1070px]:grid-cols-2 max-[380px]:grid-cols-1">
      <div className="border border-[#E2E8F0] bg-[#ffffff] rounded-2xl flex flex-col py-[25px] px-[25px] max-[560px]:px-[15px]">
        ...
        <span className="text-[32px] font-bold text-green-500 max-[560px]:text-[25px] max-[480px]:text-[20px]">
          <CountUp
            start={0}
            end={formattedSale}
            duration={2.5}
            ...
            decimal="."
            decimals={1}
            suffix={`${formatUnitOfMeasurement(String(totalSales))} UZS`}
          />
        </span>
      ...
      <div className="border border-[#E2E8F0] bg-[#ffffff] rounded-2xl flex flex-col py-[25px] px-[25px] max-[560px]:px-[15px]">
        ...
        <span
          className={`text-[32px] font-bold ${
            formattedTsexBalance > 0 ? "text-red-500" : "text-green-500"
          } max-[560px]:text-[25px] max-[480px]:text-[20px]`}
        >
          {formattedTsexBalance > 0 ? "-" : null}
          <CountUp
            start={0}
            end={formattedTsexBalance}
            duration={2.5}
            separator=" "
            decimal="."
            decimals={1}
            suffix={`${formatUnitOfMeasurement(String(totalTsexBalance))} UZS`}
          />
        </span>
        <span className="flex items-center text-green-500">
          <ArrowUp className="w-4 h-4" /> +<span>12.5</span>%
      ...
      <div className="border border-[#E2E8F0] bg-[#ffffff] rounded-2xl flex flex-col py-[25px] px-[25px] max-[560px]:px-[15px]">
        ...
        <span
          className={`text-[32px] font-bold ${
            formattedCustomerBalance < 0 ? "text-red-500" : "text-green-500"
          } max-[560px]:text-[25px] max-[480px]:text-[20px]`}
        >
          {formattedCustomerBalance < 0 ? "-" : null}
          <CountUp
            start={0}
            end={formattedCustomerBalance}
            duration={2.5}
            separator=" "
            decimal="."
            decimals={1}
            suffix={`${formatUnitOfMeasurement(
              String(totalCustomerBalance)
            )} UZS`}
          />
        </span>
        <span className="flex items-center text-green-500">
