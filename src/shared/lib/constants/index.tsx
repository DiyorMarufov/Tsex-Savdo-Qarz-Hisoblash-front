...
export const productCategories: Record<string, string> = {
  ...
  training_shoes: "Sport poyabzallari",
  keda: "Kedalar",
  football_boots: "Butsilar",
  gym_shoes: "Zal poyabzallari",
  oxfords: "Oksfordlar",
  derby: "Derbi",
  loafers: "Loferlar",
  monks: "Monklar",
  pumps: "Qayiqcha tuflilar",
  brogues: "Broglar",
  boots: "Etiklar",
  ankle_boots: "Botinkalar",
  chelsea_boots: "Chelsi etiklari",
  uggs: "Uggilar",
  timberlands: "Timberlendlar",
  jackboots: "Uzun qo'njli etiklar",
  sandals: "Sandallar",
  flip_flops: "Shlyopkalar",
  slides: "Shappaklar",
  mules: "Myulilar",
  espadrilles: "Espadrilyalar",
  clogs: "Kloglar (Sabo)",
  slippers: "Uy tapochkalari",
  mahsi: "Mahsi",
  kavush: "Kavush",
  ichigi: "Ichigi",
  moccasins: "Mokasinlar",
  slip_ons: "Sliponlar",
  high_tops: "Baland krossovkalar",
  sneakers_boots: "Krossovka-etiklar",
  ballet_flats: "Baletkalar",
};

export const productMaterialTypes: Record<string, string> = {
  natural_leather: "Tabiiy charm",
  eco_leather: "Sun'iy charm",
  pu_leather: "PU charm",
  suede: "Zamsh",
  nubuck: "Nubuk",
  velour: "Velyur",
  lacquer: "Laklangan charm",
  patent_leather: "Yaltiroq charm",
  textile: "Mato (Tekstil)",
  canvas: "Kanvas",
  mesh: "To'rli mato",
  denim: "Jinsi matosi",
  satin: "Satin (Atlas)",
  knitted_fabric: "To'qilgan mato",
  synthetic: "Sintetika",
  pvc: "PVX",
  rubber: "Rezina",
  fur: "Mo'yna",
